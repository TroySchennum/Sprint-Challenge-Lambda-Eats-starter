...
Used to access a match without rendering a route. Good for nesting.

2. How would you explain form validation to someone who has never programmed before?

It's the error you get when you put the wrong thing into forms.

3. In 1-2 sentences, define end to end testing.

It tests the flow of the whole application from beginning to end. Comprehensive testing.
